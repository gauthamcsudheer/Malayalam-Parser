...
\end{itemize}
	...
	\paragraph\ 
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{./explore.jpeg}
			\caption{Different POS tags}
		\end{figure}
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{./csv.jpeg}
			\caption{POS tagged malayalam text}
		\end{figure}
		...
		\section{Discussion}
		\paragraph\
		In summary, the project has developed a Malayalam parser for dataset creation, offering three essential datasets: POS-tagged, named entity labeled, and sentiment labeled. Despite efforts to integrate rules and machine learning for accuracy improvement, this remains a future goal. The project has established a solid foundation for processing and analyzing Malayalam text, with potential implications for advancing NLP applications in Malayalam.
		...
		In conclusion, the development of a comprehensive Malayalam language processing tool represents a significant advancement in NLP applications for the Malayalam language. This tool facilitates accurate linguistic analysis and dataset generation, supporting essential tasks such as part-of-speech tagging, named entity recognition, and sentiment analysis. By enabling the parsing and analysis of Malayalam text, the tool enhances understanding of the language's grammatical structure, syntax, and semantics. Overall, this project makes a substantial contribution to advancing language processing technologies in Malayalam, setting the stage for future innovations in NLP for this language.

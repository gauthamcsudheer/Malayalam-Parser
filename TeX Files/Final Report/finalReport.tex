...
\begin{document}
	...
	\begin{flushleft}
		...
		\begin{longtable}{p{10.3cm} p{8cm} p{5.25cm}}
		   ...
		   \small\textbf{Dr.Mary Priya Sebastian}    &\small\textbf{Dr.Saritha S} \\
	...
	\begin{itemize}
		...
		This chapter presents an overview of the testing process and discussion. 
...
%	\section{Overall Description}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=6cm]{./system_design.jpg}
...
\end{itemize}
	...
	\paragraph\ 
		...
		\section{Overview}
		\paragraph\
		Our project provides three essential datasets for Malayalam text analysis: POS-tagged,
		named entity labeled, and sentiment labeled. We also include POS tag information and
		examples from the datasets to make it easier for users to understand the tags. The
		implementation of the parser involved the use of the translation method. Additionally,
		we experimented with rule-based approaches and a bidirectional LSTM model. Although
		it produced $ \approx 20\% $ increase in classifying verbs, we did not integrate them into the main
		project due to accuracy concerns.
		
		Despite not integrating the machine learning models, we have elevated the translation
		model and made significant strides in improving the classification of verbs using a machine
		learning approach. This advancement enhances the parser’s ability to accurately capture
		and analyze the syntactic and semantic structures of Malayalam sentences.
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=10cm]{./mal_parser.jpeg}
			\caption{Malayalam Parser Output}
		\end{figure}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=14cm]{./csv.jpeg}
			\caption{POS tagged malayalam dataset}
		\end{figure}
		
		
	    \section{Quantitative Results}
	    	\paragraph\
	    	Based on the results obtained using bidirectional LSTM models, the confusion matrix and performance metrics are given below:
	    	\begin{figure}[H]
	    		\centering
	    		\includegraphics[width=10cm]{./confusion_matrix.jpeg}
	     ...
	     \begin{table}[h!]
	     	...
	     	\begin{tabular}{|c|c|}
	     		...
	     		\hline
	     	\end{tabular}
	     	\caption{Performance Metrics of Translation Model}
	     	\label{table:metrics}
	     \end{table}
	
		\section{Discussion}
		\paragraph\		
			Our project lays a solid foundation for processing and analyzing Malayalam text and
			has the potential to advance NLP applications for the language. Future work will focus
			on refining and integrating the rule-based and machine learning approaches, enhancing
			the bidirectional LSTM model, and investigating advanced machine learning models like
			dependency parsing or deep learning for better accuracy and robustness. Implementing error correction mechanisms and user feedback options to handle inaccuracies and im-
			prove parser quality, along with engaging with the local community for feedback, will be	essential.
			
			The “Malayalam Parser for Dataset Creation” project aligns with the broader goal of
			promoting linguistic diversity in NLP, addressing the challenges posed by the scarcity of
			resources for underrepresented languages. Through the development of this parser, the
			project aims to facilitate further research and innovation in Malayalam NLP, opening
			avenues for the exploration of various language-related tasks and applications.
        ...
        The project aimed to develop a Malayalam Parser for Dataset Creation, focusing on tasks such as part-of-speech tagging, named entity recognition, and sentiment analysis. The main goal was to create annotated datasets for Malayalam NLP applications, which are currently scarce.The system provides POS-tagged, named entity labeled, and sentiment labeled datasets.It has a user-friendly interface for inputting Malayalam text and getting analyzed results.This parser helps with various applications, including sentiment analysis, translation, and summarization, making it easier to work with Malayalam text in technology.It also supports research and learning in NLP and Malayalam linguistics, offering valuable resources for scholars and developers.
        
        The creation of this Malayalam Parser is a significant step forward in developing linguistic tools for the Malayalam language.By providing annotated datasets and robust analysis capabilities, the project not only preserves and promotes Malayalam but also opens new opportunities for technology applications in Malayalam-speaking regions.Future work includes improving accuracy obtained by using ruled based and bidirectional LSTM model, expanding the dataset with more diverse examples, and handling complex linguistic structures in Malayalam.This project lays a strong foundation for future enhancements and broader applications, ensuring Malayalam remains a vital part of the technological landscape.
		...
		Future work will focus on refining and integrating the rule-based and machine learning approaches, enhancing the bidirectional LSTM model, and investigating advanced machine learning models like dependency parsing or deep learning for better accuracy and robustness.Implementing error correction mechanisms and user feedback options to handle inaccuracies and improve parser quality, along with engaging with local community for feedback, will be essential.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0001.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0002.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0003.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0004.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0005.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0006.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0007.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0008.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0009.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0010.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0011.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0012.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0013.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0014.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0015.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0016.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0017.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0018.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0019.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0020.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0021.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0022.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0023.jpg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=14cm]{./ppt/Final Presentation_page-0024.jpg}
	\end{figure}
	...
	\cleardoublepage
		...
		\begin{center}
			...
			\begin{figure}[htbp]
					\centering
			\includegraphics[scale=0.25]{logo (1).jpg}
			%		\includegraphics[width=8.0cm]{logo (1).jpg}\\[0.5cm]
				\end{figure}
	...
	Apply engineering and management principles to achieve the goal of the project (Cognitive Knowledge Level: Apply)
		...
		\begin{center}
			...
			\includepdf[pages=1-8]{Co po (2).pdf}

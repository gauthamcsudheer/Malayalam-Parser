...
\end{itemize}
	...
	\paragraph\ 
		...
		The project has developed a Malayalam Parser for Dataset Creation.However, due to timing constraints, integrating the rule-based and machine learning-based approach remains a future enhancement.
		
		The project's deviation from its initial goal of integrating rules and machine learning underscores the challenges in accurately processing Malayalam text.Factors such as the language's linguistic complexities and the limited availability of annotated data likely contributed to this deviation.Nevertheless, creating valuable datasets represents a significant step toward overcoming the shortage of resources for NLP in Malayalam.
